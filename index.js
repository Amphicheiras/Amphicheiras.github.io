 ...
 * @async
 *
 * @throws {Error} If there is any error in fetching the blogs from Medium
 *     profile.
 *
 * @returns {void}
 */
...
function mapBasicResponse(basics) {
  ...
  // added title of page
  window.parent.document.title = 'Aristotelis Symeonakis';
}
 ...
 * @param {string} id - The id of the HTML element to which bio will be
 *     appended.
 *
 * @returns {void}
 */
 ...
 * @param {string} id - The id of the HTML element to which skills will be
 *     appended.
 *
 * @returns {void}
 */
 ...
 * @param {string} id - The id of the HTML element to which projects will be
 *     appended.
 *
 * @returns {void}
 */
 ...
 * @param {string} id - The ID of the parent element where the list of posts
 *     will be appended
 *
 * @returns {undefined}
 */
 ...
 * @property {Array} items[].details - An array of details for the timeline
 * item.
 ...
 * @param {String} id - Id of the footer section in which the links will be
 *     populated
 *
 * @return {undefined}
 */
...
populateProjects(juceProjects, 'juce-projects');
populateProjects(esp32Projects, 'esp32-projects');
populateProjects(audioProjects, 'audio-projects');
